...
const ModalAdd = (props) => {
  ...
  async function Save() {
    ...
    if (cardId.length > 0 && userName.length != "") {
    ...
    <div className={styles.panelHome}>
      <div className={styles.paneRight}>
        <div className={styles.groupButton}>
          ...
          >
            <FontAwesomeIcon icon={faAdd} fontSize={20} className="spacing" />{" "}
            Thêm
          </button>
        </div>
                ...
                return (
                  <tr key={item.id}>
                    ...
                    <td>
                      <button
                        type="button"
                        className="btn btn-warning style-btn space"
      ...
      />
      {showModalEdit ? (
        <ModalEdit handSaveSuccess={handSaveSuccess} dataRow={dataRow} />
      ) : null}
      <style global jsx>{`
        tbody,
        td,
